...
import { createSession, getSessionById, insertImage, incrementAndGetSession } from '../models/optimizeModel.js';
...
export const processUploadedFile = async (req, res) => {
    ...
    try {
        ...
        await insertImage(sessionId, file.originalname, originalSize, optimizedName, result.size, originalFormat, options.format ?? 'webp', savings, result.width, result.height);
...
//# sourceMappingURL=optimizeController.js.map