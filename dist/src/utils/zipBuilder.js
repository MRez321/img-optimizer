...
const readDirectoryRecursive = async (dirPath, zipObject = {}, rootDir = dirPath) => {
...
export const createZip = async (sourceDir, zipPath) => {
    try {
        const zipData = await readDirectoryRecursive(sourceDir, {}, sourceDir);
